                ...
                <form action="<?= base_url('employe/demande') ?>" method="post">
                  ...
                  <div class="form-grid-2" style="margin-bottom:1rem">
                    <div class="f-group">
                      ...
                      <input type="datetime-local" class="f-input" name="date_debut" value="<?= esc(old('date_debut') ?? '') ?>" required />
                    </div>
                    <div class="f-group">
                      <label class="f-label">Date de fin <span style="color:var(--danger)">*</span></label>
                      <input type="datetime-local" class="f-input" name="date_fin" value="<?= esc(old('date_fin') ?? '') ?>" required />
                    </div>
                  </div>

                  <div class="f-group" style="margin-bottom:1rem">
                    <label class="f-label">Motif (optionnel)</label>
                    <textarea class="f-textarea" name="motif" placeholder="Precisez le motif de votre demande si necessaire..."><?= esc(old('motif') ?? '') ?></textarea>
